...
namespace Forge.OpenAI.Models.FineTunes
{
    ...
    public class FineTuneCreateRequest : RequestBase
    {
        ...
        /// <summary>Initializes a new instance of the <see cref="FineTuneCreateRequest" /> class.</summary>
        public FineTuneCreateRequest()
        {
            Model = KnownModelTypes.Curie;
        }

        /// <summary>Initializes a new instance of the <see cref="FineTuneCreateRequest" /> class.</summary>
        /// <param name="trainingFileId">The training file identifier.</param>
        /// <param name="validationFileId">The validation file identifier.</param>
        /// <param name="model">The model.</param>
        /// <param name="epochs">The epochs.</param>
        /// <param name="batchSize">Size of the batch.</param>
        /// <param name="learningRateMultiplier">The learning rate multiplier.</param>
        /// <param name="promptLossWeight">The prompt loss weight.</param>
        /// <param name="computeClassificationMetrics">if set to <c>true</c> [compute classification metrics].</param>
        /// <param name="classificationNClasses">The classification n classes.</param>
        /// <param name="classificationPositiveClasses">The classification positive classes.</param>
        /// <param name="classificationBetas">The classification betas.</param>
            ...
            string suffix = null)
        {
            ...
            Model = model ?? KnownModelTypes.Curie;
            Epochs = (int)epochs;
            BatchSize = batchSize;
