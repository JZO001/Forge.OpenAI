...
namespace Forge.OpenAI.Models.Shared
{
    ...
    public class MessageContent
    {
        ...
        public MessageContent(MessageContentImageFile messageContentImageFile)
            : this("image_file")
        {
            if (messageContentImageFile == null)
                throw new ArgumentNullException(nameof(messageContentImageFile));
        ...
        public MessageContent(string type, MessageContentImageUrl messageContentImageUrl)
            : this(type)
        {
            if (messageContentImageUrl == null)
                throw new ArgumentNullException(nameof(messageContentImageUrl));
    ...
    public class MessageContentImageFile
    {
        ...
        public MessageContentImageFile(string fileId, string detail)
            : this(fileId)
        {
            Detail = detail;
        }
    ...
    public class MessageContentImageUrl
    {
        ...
        /// <param name="url">The URL.</param>
        /// <param name="detail">The detail.</param>
        public MessageContentImageUrl(string url, string detail)
            : this(url)
        {
            Detail = detail;
        }
